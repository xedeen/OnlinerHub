...
namespace Onliner.OnlinerHub {
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Runtime.Serialization", "4.0.0.0")]
    [System.Runtime.Serialization.DataContractAttribute(Name="ContentItem", Namespace="http://schemas.datacontract.org/2004/07/CacheHub.Model2")]
    public partial class ContentItem : object, System.ComponentModel.INotifyPropertyChanged {
        
        private Onliner.OnlinerHub.ContentItemType ContentTypeField;
        
        private string LatestLinkField;
        
        private string XamlField;
        
        [System.Runtime.Serialization.DataMemberAttribute()]
        public Onliner.OnlinerHub.ContentItemType ContentType {
            get {
        ...
        public string LatestLink {
            get {
                return this.LatestLinkField;
            }
            set {
                if ((object.ReferenceEquals(this.LatestLinkField, value) != true)) {
                    this.LatestLinkField = value;
                    this.RaisePropertyChanged("LatestLink");
                }
            }
        }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Runtime.Serialization", "4.0.0.0")]
    [System.Runtime.Serialization.DataContractAttribute(Name="ContentItemType", Namespace="http://schemas.datacontract.org/2004/07/CacheHub.Model2")]
    ...
    public interface IOnlinerHub {
        ...
        [System.ServiceModel.OperationContractAttribute(AsyncPattern=true, Action="http://tempuri.org/IOnlinerHub/GetContentXaml", ReplyAction="http://tempuri.org/IOnlinerHub/GetContentXamlResponse")]
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class GetContentXamlCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        public GetContentXamlCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
        
        public System.Collections.ObjectModel.ObservableCollection<Onliner.OnlinerHub.ContentItem> Result {
            get {
                base.RaiseExceptionIfNecessary();
                return ((System.Collections.ObjectModel.ObservableCollection<Onliner.OnlinerHub.ContentItem>)(this.results[0]));
            }
        }
    }
    ...
    public partial class OnlinerHubClient : System.ServiceModel.ClientBase<Onliner.OnlinerHub.IOnlinerHub>, Onliner.OnlinerHub.IOnlinerHub {
        ...
        private BeginOperationDelegate onBeginGetContentXamlDelegate;
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult Onliner.OnlinerHub.IOnlinerHub.BeginGetContentXaml(string articleUrl, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginGetContentXaml(articleUrl, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Collections.ObjectModel.ObservableCollection<Onliner.OnlinerHub.ContentItem> Onliner.OnlinerHub.IOnlinerHub.EndGetContentXaml(System.IAsyncResult result) {
            return base.Channel.EndGetContentXaml(result);
        }
        
        private System.IAsyncResult OnBeginGetContentXaml(object[] inValues, System.AsyncCallback callback, object asyncState) {
            string articleUrl = ((string)(inValues[0]));
            return ((Onliner.OnlinerHub.IOnlinerHub)(this)).BeginGetContentXaml(articleUrl, callback, asyncState);
        }
        
        private object[] OnEndGetContentXaml(System.IAsyncResult result) {
            System.Collections.ObjectModel.ObservableCollection<Onliner.OnlinerHub.ContentItem> retVal = ((Onliner.OnlinerHub.IOnlinerHub)(this)).EndGetContentXaml(result);
            return new object[] {
                    retVal};
        }
        
        private void OnGetContentXamlCompleted(object state) {
            if ((this.GetContentXamlCompleted != null)) {
                InvokeAsyncCompletedEventArgs e = ((InvokeAsyncCompletedEventArgs)(state));
                this.GetContentXamlCompleted(this, new GetContentXamlCompletedEventArgs(e.Results, e.Error, e.Cancelled, e.UserState));
            }
        }
        
        public void GetContentXamlAsync(string articleUrl) {
            this.GetContentXamlAsync(articleUrl, null);
        }
        
        public void GetContentXamlAsync(string articleUrl, object userState) {
            if ((this.onBeginGetContentXamlDelegate == null)) {
                this.onBeginGetContentXamlDelegate = new BeginOperationDelegate(this.OnBeginGetContentXaml);
            }
            if ((this.onEndGetContentXamlDelegate == null)) {
                this.onEndGetContentXamlDelegate = new EndOperationDelegate(this.OnEndGetContentXaml);
            }
            if ((this.onGetContentXamlCompletedDelegate == null)) {
                this.onGetContentXamlCompletedDelegate = new System.Threading.SendOrPostCallback(this.OnGetContentXamlCompleted);
            }
            base.InvokeAsync(this.onBeginGetContentXamlDelegate, new object[] {
        ...
        private class OnlinerHubClientChannel : ChannelBase<Onliner.OnlinerHub.IOnlinerHub>, Onliner.OnlinerHub.IOnlinerHub {
            ...
            public System.IAsyncResult BeginGetContentXaml(string articleUrl, System.AsyncCallback callback, object asyncState) {
                object[] _args = new object[1];
                _args[0] = articleUrl;
                System.IAsyncResult _result = base.BeginInvoke("GetContentXaml", _args, callback, asyncState);
                return _result;
            }
